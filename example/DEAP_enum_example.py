# -*- coding: utf-8 -*-
"""
Created on Mon Oct  1 16:55:55 2018

@author: Yongrui Huang

  This is an example for processing enum fusion algorithm in DEAP dataset using the function in ../algorithm_implement/enum_tool
