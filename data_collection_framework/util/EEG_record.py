# -*- coding: utf-8 -*-
"""
Created on Thu Oct 18 11:42:40 2018
...
class EEGRecorder(record.AbstractRecorder):
    '''
      ...
      for my development.
        You may noticed that the code here is very complexe. However, I just copied
            ...
            if ready == 1:
                ...
                for i in channelList:
                    ...
                    if result == 0:    #EDK_OK
                        ...
                        EEG_row[j*5+0], EEG_row[j*5+1], EEG_row[j*5+2], EEG_row[j*5+3], EEG_row[j*5+4] = thetaValue.value, alphaValue.value, low_betaValue.value, high_betaValue.value, gammaValue.value
                    j += 1
