# -*- coding: utf-8 -*-
"""
Created on Wed Oct 17 14:45:35 2018
...
class AbstractRecorder(metaclass=ABCMeta):
    '''
        ...
        Attributes:
          ...
          its data will be written into harddisk and then be clear.
    ...
    def record(self):
        '''
            ...
            I use a loop to continue reading data into queue from sensor. It 
          wiil be terminated when the trial ends.
        '''
        while True:
    ...
    def save(self):
        ...
        path = self.base_path + str(subject_id) + '/trial_' + str(self.trial_id) +'/' + self.save_file_name + '.npy'
        
        data_numpy_arr = np.array(self.data_list)
        
        np.save(path, data_numpy_arr)
    ...
    def record_one_sample(self):
        '''
          ...
          your model is a vedio. Please check how I implement it in face_record.py.
